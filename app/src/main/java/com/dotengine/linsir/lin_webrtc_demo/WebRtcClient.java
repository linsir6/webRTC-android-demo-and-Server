...
public class WebRtcClient {
    ...
    public WebRtcClient(RtcListener listener, String host, PeerConnectionParameters params, android.opengl.EGLContext mEGLcontext) {
        mListener = listener;
        pcParams = params;
    ...
    private void setCamera() {
        ...
        if (pcParams.videoCallEnabled) {
            ...
            videoConstraints.mandatory.add(new MediaConstraints.KeyValuePair("maxHeight", Integer.toString(pcParams.videHeight)));
        ...
        localMS.addTrack(factory.createAudioTrack("ARDAMSv0",audioSource));
